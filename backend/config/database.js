...
const pool = new Pool({
    ...
    // Deshabilitar SSL si se especifica en la URL o env (útil para self-hosted)
    ssl: (process.env.DATABASE_URL && process.env.DATABASE_URL.includes('sslmode=disable')) ? false : undefined
});
